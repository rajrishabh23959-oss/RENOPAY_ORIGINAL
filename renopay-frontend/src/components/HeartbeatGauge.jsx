    ...
    <Card className="px-[18px] pt-4 pb-3" style={{ border: `1px solid ${col}33` }}>
      ...
      <div className="flex items-end gap-3">
        <svg width="160" height="82" viewBox="0 0 160 82">
          <path d={arcPath(-180, 0)} fill="none" stroke="#2A2320" strokeWidth="10" strokeLinecap="round" />
          <path d={arcPath(-180, -108)} fill="none" stroke="#22C55E88" strokeWidth="10" strokeLinecap="round" />
          <path d={arcPath(-108, -54)} fill="none" stroke="#FFA00088" strokeWidth="10" strokeLinecap="round" />
          <path d={arcPath(-54, 0)} fill="none" stroke="#ff3d6088" strokeWidth="10" strokeLinecap="round" />
          <path
            d={arcPath(-180, Math.min(0, -180 + spendScore * 1.8))} fill="none" stroke={col} strokeWidth="10"
            strokeLinecap="round" style={{ transition: "all 1s ease", filter: `drop-shadow(0 0 4px ${col})` }}
          />
          ...
          <text x="14" y="76" fontSize="8" fill="#22C55E">Safe</text>
          <text x="68" y="20" fontSize="8" fill="#FFA000">Mid</text>
          <text x="130" y="76" fontSize="8" fill="#ff3d60">Risk</text>
        </svg>
